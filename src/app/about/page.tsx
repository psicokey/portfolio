  ...
  return (
    <div className="container mx-auto px-4 py-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 items-center mb-12">
          ...
          <div className="md:col-span-2">
            ...
            <p className="text-lg mb-4 text-gray-700 dark:text-gray-300">
              Desarrollador Web Full-Stack profesional con{" "}
              <span className="font-semibold text-blue-600 dark:text-blue-400">
                más de 10 años de experiencia
              </span>{" "}
              como licenciado en psicología. Esta combinación única me permite
              crear soluciones tecnológicas con un fuerte enfoque en la
              experiencia del usuario, comunicación efectiva y trabajo en
              equipo.
            </p>
            <div className="bg-blue-50 dark:bg-blue-900/30 p-4 rounded-lg border-l-4 border-blue-500">
              <p className="text-gray-700 dark:text-gray-300">
                &quot;Mi experiencia única en psic ología combinada con
                habilidades técnicas sólidas me permite crear soluciones
                digitales que entienden profundamente las necesidades de los
                usuarios y facilitan la colaboración efectiva entre
                equipos.&quot;
              </p>
            </div>
          </div>
          ...
          >
            <div className="space-y-4">
              ...
              <JourneyCard
                ...
                description="Creando soluciones digitales profesionales: aplicaciones web modernas, integración de APIs (Meta, Shopify) y sistemas de automatización para empresas."
              />
            </div>
          </Section>
        </div>
      ...
      <Section
        ...
        icon={<FaHeart className="text-blue-600 dark:text-blue-400" />}
      >
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          <div className="bg-gradient-to-r from-blue-500 to-purple-600 rounded-xl p-6 text-white">
            ...
            <p>
              Disfruto tocar la batería como forma de expresión creativa y
              desconexión. La música me ayuda a mantener el equilibrio entre el
              trabajo técnico y la expresión artística.
            </p>
          </div>
          ...
          <div className="bg-gradient-to-r from-green-500 to-teal-600 rounded-xl p-6 text-white">
            ...
            <p>
              Salir a caminar me ayuda a despejar la mente y encontrar
              inspiración. Disfruto explorar nuevos lugares y conectarme con la
              naturaleza.
            </p>
          </div>
        </div>
      ...
      >
        <div className="bg-white dark:bg-gray-800 rounded-xl shadow-md p-6">
          <p className="text-lg mb-4 text-gray-700 dark:text-gray-300">
            ¿Quieres colaborar en un proyecto o simplemente charlar sobre
