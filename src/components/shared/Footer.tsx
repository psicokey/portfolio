...
export default function Footer() {
  ...
  <div className="mx-auto max-w-5xl px-4 py-4 sm:px-6 lg:px-8">
    ...
    <p className="mx-auto mt-6 max-w-md text-center leading-relaxed text-gray-600 dark:text-gray-300">
    ...
    <ul className="mt-12 flex flex-wrap justify-center gap-6 md:gap-8 lg:gap-12">
      ...
      <li>
        <a className="text-gray-700 dark:text-gray-200 transition hover:text-gray-700/75 dark:hover:text-gray-300" href="/about"> Sobre mí </a>
      </li>
      ...
      <li>
        <a className="text-gray-700 dark:text-gray-200 transition hover:text-gray-700/75 dark:hover:text-gray-300" href="/skills"> Habilidades </a>
      </li>

      <li>
        <a className="text-gray-700 dark:text-gray-200 transition hover:text-gray-700/75 dark:hover:text-gray-300" href="/contact"> Contacto </a>
      </li>
    </ul>
    ...
    <ul className="mt-12 flex justify-center gap-6 md:gap-8">
      <li>
        <a
          href="https://instagram.com/psic.keyberth"
          rel="noreferrer"
          target="_blank"
  ...
  <div className="text-gray-600 dark:text-gray-400 mb-4"> © {new Date().getFullYear()} Keyberth Márquez · Desarrollador Web</div>
</footer>
  );
}